...
<ol id="expert-instructions">
	...
	<ol>
		...
		<li>You will receive a verification email from the Integrated Public Use Microdata Series. Verify your email, log in, and you will see a table with your extract history.</li>
